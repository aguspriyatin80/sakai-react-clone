...
export const Crud = () => {
    ...
    const deleteProduct = () => {
        ...
        // setProducts(_products);
        if (_products) {
            // axios.delete(`http://localhost:3004/data/${product.id}`)
    ...
    const rightToolbarTemplate = () => {
        return (
            <React.Fragment>
                <FileUpload mode="basic" accept="image/*" maxFileSize={1000000} label="Import" chooseLabel="Import" className="inline-block mr-2" />
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="actions">
                <Button icon="pi pi-pencil" className="mr-2 p-button-rounded p-button-success" onClick={() => editProduct(rowData)} />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={products} selection={selectedProducts}
                        ...
                        onClick={(e) => setSelectedProducts(e.value)}
